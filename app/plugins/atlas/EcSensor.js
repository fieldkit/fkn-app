        ...
        return (
            <View>
                ...
                <View style={atlasStyles.buttons.largeButton}>
                    <Button title="K = 0.1" onPress={() => this.onSetProbe("0.1")} />
                </View>
                <View style={atlasStyles.buttons.largeButton}>
                    <Button title="K = 1" onPress={() => this.onSetProbe("1")} />
                </View>
                <View style={atlasStyles.buttons.largeButton}>
                    <Button title="K = 10" onPress={() => this.onSetProbe("10")} />
                </View>
...
class TemperatureCompensationStep extends ScriptStep {
    ...
    renderStep() {
        ...
        return (
            <View>
                <Paragraph>Temperature has a significant effect on conductivity readings. The EZO™ Conductivity circuit has its temperature compensation set to 25˚ C as the default. If the calibration solution is not within 5˚ of 25˚ C, check the temperature chart on the side of the calibration bottle, and calibrate to that value.</Paragraph>
                ...
                <Slider style={{ paddingTop: 20, paddingBottom: 20 }} step={5} minimumValue={5} maximumValue={50} onValueChange={this.onTemperatureChange.bind(this)} value={temperature} />
            </View>
        );
    }
}
