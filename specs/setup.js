...
// Without this I was getting weird errors, only on the CI server, though. I couldn'ts
// for the life of me reproduce them locally. The errors were about:
...
NativeModules.MGLModule = {
    // constants
    UserTrackingModes: keyMirror(["None", "Follow", "FollowWithCourse", "FollowWithHeading"]),
    StyleURL: keyMirror(["Street", "Dark", "Light", "Outdoors", "Satellite", "SatelliteStreet", "TrafficDay", "TrafficNight"]),
    EventTypes: keyMirror(["MapClick", "MapLongClick", "RegionWillChange", "RegionIsChanging", "RegionDidChange", "WillStartLoadingMap", "DidFinishLoadingMap", "DidFailLoadingMap", "WillStartRenderingFrame", "DidFinishRenderingFrame", "DidFinishRenderingFrameFully", "DidFinishLoadingStyle", "SetCameraComplete"]),
    CameraModes: keyMirror(["Flight", "Ease", "None"]),
    StyleSource: keyMirror(["DefaultSourceID"]),
    InterpolationMode: keyMirror(["Exponential", "Categorical", "Interval", "Identity"]),
    ...
    TextAnchor: keyMirror(["Center", "Left", "Right", "Top", "Bottom", "TopLeft", "TopRight", "BottomLeft", "BottomRight"]),
